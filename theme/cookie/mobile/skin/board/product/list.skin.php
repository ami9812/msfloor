    ...
    <ul id="gall_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>">
            ...
            <?php
                ...
                if($thumb['src']) {
                    $img_content = '<img src="'.G5_THEME_IMG_URL.'/bi.png" style="position:absolute; width:110px; margin:15px 20px;z-index:98;"><img src="'.$thumb['src'].'" alt="'.$thumb['alt'].'" width="'.$board['bo_mobile_gallery_width'].'" height="'.$board['bo_mobile_gallery_height'].'">';
                } else {
