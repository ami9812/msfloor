...
<article id="bo_v">
    ...
    <section id="bo_v_atc">
        ...
        if($v_img_count) {
         ...
         ?>
        <style>
            table {max-width:1200px;width:100%;border-top:2px solid #006600;border-bottom:1px solid #999;font-size:16px;line-height: 35px;border-collapse: collapse;}
th {background: #eee;border-bottom:1px solid #ccc;}
td {padding-left:20px;border-bottom:1px solid #ccc;}
</style>
        <div id="bo_v_con">
        <table>
            <colgroup>
            ...
            <tbody>
                ...
                <tr>
                    <th>연락처</th>
                    <td><?php echo $view['wr_7']; ?>-<?php echo $view['wr_8']; ?>-<?php echo $view['wr_9']; ?></td>
                </tr>
                <tr>
                    <th>문의내용</th>
