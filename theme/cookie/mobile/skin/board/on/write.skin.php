...
if ($g5['title'] == "공지사항"){
    ...
    echo '<li><a href="'.G5_BBS_URL.'/board.php?bo_table=notice" id="bo_cate_on">공지사항</a></li>';
    echo '<li><a href="'.G5_BBS_URL.'/write.php?bo_table=online">온라인 문의</a></li>';
    echo '<li><a href="'.G5_BBS_URL.'/board.php?bo_table=qa">질문답변</a></li>';
    echo '</ul>';
    echo '</nav>';
}elseif ($g5['title'] == "온라인 문의"){
    echo '<nav id="bo_cate">';
    echo '<ul id="bo_cate_ul">';
    echo '<li><a href="'.G5_BBS_URL.'/board.php?bo_table=notice">공지사항</a></li>';
    echo '<li><a href="'.G5_BBS_URL.'/write.php?bo_table=online" id="bo_cate_on">온라인 문의</a></li>';
    echo '<li><a href="'.G5_BBS_URL.'/board.php?bo_table=qa">질문답변</a></li>';
    echo '</ul>';
    echo '</nav>';
}elseif ($g5['title'] == "질문답변"){
    echo '<nav id="bo_cate">';
    echo '<ul id="bo_cate_ul">';
    echo '<li><a href="'.G5_BBS_URL.'/board.php?bo_table=notice">공지사항</a></li>';
    echo '<li><a href="'.G5_BBS_URL.'/write.php?bo_table=online">온라인 문의</a></li>';
    echo '<li><a href="'.G5_BBS_URL.'/board.php?bo_table=qa" id="bo_cate_on">질문답변</a></li>';
    echo '</ul>';
    echo '</nav>';
}elseif ($is_category) { ?>
<nav id="bo_cate">
...
<section id="bo_w">
    ...
    <!--<label for="provision-check" style="line-height: 45px;">
        <input id="provision-check" type="checkbox" name="wr_6" value="<?php //echo $wr_6 ?>" id="wr_6" />
        ...
        <div class="write_div" style="display:none">
            ...
            <input type="text" name="wr_name" value="<?php echo $wr_subject ?>" id="wr_name" maxlength="20" placeholder="이름">
        </div>
        <?php } ?>
        ...
        <div class="bo_w_tit write_div">
            ...
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" placeholder="이름(필수입력)">
        </div>
        <div class="bo_w_tit write_div" style="text-align: left">
            <select name="wr_7" id="wr_7" class="frm_select" value="<?php echo $wr_7 ?>" required itemname="연락처" style="width:30%;">
            ...
            <input type="text" name="wr_8" maxlength="4" value="<?php echo $wr_8 ?>" required itemname="연락처" required class="frm_input required" placeholder="연락처" style="width:33%"/>
            <input type="text" name="wr_9" maxlength="4" value="<?php echo $wr_9 ?>" required itemname="연락처" required class="frm_input required" placeholder="필수입력" style="width:33%"/>
        </div>
        <div class="write_div">
        ...
        <div class="write_div" style="display:none">
            ...
            <input type="password" name="wr_password" id="wr_password" value="<?php echo $wr_password ?>" class="frm_input full_input" maxlength="20" placeholder="비밀번호(필수입력)">
        </div>
        <?php } ?>
